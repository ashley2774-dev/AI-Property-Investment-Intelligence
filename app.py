...
def main():
    ...
    with tabs[3]:
        ...
        st.write(
            "Upload a CSV using the provided template. The app will calculate financial features, align the frame to the training feature list, and score each property with the real model."
        )
